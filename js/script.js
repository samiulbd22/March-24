...
const members = {
    ...
    serviceBill     :30,
    othersBill      :0,
    runningMonth    :"March-24",
    previousMonth   :"February-24", // new addDecember
    ...
    "01922362569":{
        ...
        previous_paid       :4000,
        previous_dining_cost:1400,
        payment             :{"10/03/24-Cash":2200,"16/03/24-DDBL":1000,"20/03/24-DDBL":500,"25/03/24-DDBL":1000,"31/03/24-Bazar":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
    ...
    "01532023080":{
        ...
        payment             :{"03/03/24-Cash":3000,"08/03/24-Cash":1000,"16/03/24-Cash":1000,"18/03/24-Bkash":500,"22/03/24-Cash":500,"22/03/24-Cash":500},
        // running month
        stay_cost       :2500,
        garage_cost     :500,
    ...
    "01640454889":{
        ...
        post_payable        :2135,
        previous_paid       :5000,
        previous_dining_cost:2744,
        payment             :{"08/03/24-Cash":6000},
        // running month
        stay_cost       :2330,
        garage_cost     :0,
    ...
    "01714443406":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1400,
        payment             :{"06/03/24-Cash":4000,"13/03/24-Cash":2000,"25/03/24-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01834648400":{
        ...
        previous_paid       :7300,
        previous_dining_cost:1400,
        payment             :{"10/03/24-Bkash":2500,"19/03/24-Cash":1100,"23/03/24-Cash":200,"29/03/24-Cash":800},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :2426,
        running_paid    :4600,
        running_meal    :40,
        // method calling
        preMonth,
